...
const Skeleton = () => (
  <div
    className="flex flex-1 w-full h-full min-h-[6rem] rounded-xl bg-dot-white/[0.2] [mask-image:radial-gradient(ellipse_at_center,white,transparent)] border border-cyan-500/10 bg-black/20"></div>
);
const items = [
  {
    ...
    icon: <IconClipboardCopy className="h-4 w-4 text-cyan-400/60" />,
  },
  {
    ...
    icon: <IconFileBroken className="h-4 w-4 text-cyan-400/60" />,
  },
  {
    ...
    className: "md:col-span-1",
    icon: <IconSignature className="h-4 w-4 text-cyan-400/60" />,
  },
  {
    ...
    className: "md:col-span-2",
    icon: <IconTableColumn className="h-4 w-4 text-cyan-400/60" />,
  },
];
